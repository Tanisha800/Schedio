                ...
                {step === "email" ? (
                  ...
                  >
                    ...
                    <div className="flex w-full gap-3">
                      ...
                      <motion.button
                        className={`flex-1 rounded-full font-medium py-3 border transition-all duration-300 ${password.trim() && !loading
                  ...
                  >
                    ...
                    <div className="flex w-full gap-3">
                      ...
                      <motion.button
                        className={`flex-1 rounded-full font-medium py-3 border transition-all duration-300 ${name.trim() && password.trim() && !loading
                          ? "bg-white text-black border-transparent hover:bg-white/90 cursor-pointer"
                          : "bg-[#111] text-white/50 border-white/10 cursor-not-allowed"
                          }`}
